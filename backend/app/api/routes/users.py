...
from app.api.shemas.users import (
    AssignRolesRequest, UserPage,UserCreate, UserUpdate
)
...
@router.get("/{user_id}/roles",response_model=UserRead,operation_id="assignUserRoles")
