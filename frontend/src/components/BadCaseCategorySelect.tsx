...
export function BadCaseCategorySelect({value,onChange,allowClear=true,
    style,placeholer="选择归因类别"
}:Props){
    return (<Select
        ...
        options={(Object.keys(BAD_CASE_CATEGORY_LABELS) as BadCaseCategory[]).map(
            (key)=>({
                value:key,
